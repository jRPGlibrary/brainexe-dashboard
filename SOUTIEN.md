...
>
> 💜 — *Brainee, version 0.14.0, mai 2026*
...
Cette politique de soutien s'applique aux versions **`v0.4.2` → `v0.14.0`** (versions actuelles). Avant `v0.4.2`, le système de funding n'existait pas — Brain payait tout sans tracking.
