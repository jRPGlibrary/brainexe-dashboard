...
RÈGLES ABSOLUES :
- conclus naturellement quand c'est le bon moment — relance uniquement si c'est vraiment justifié
...
async function postRandomConversation() {
  ...
  try {
    ...
    const content = await callClaude(
      ...
      `Salon : ${ch.topic}. Maximum 3 phrases. Commence direct. Angle frais. Conclus si c'est le bon moment — pas de question forcée.`,
      150
    );
