/**
 * ================================================
 * 🧠 BRAINEXE DASHBOARD — Serveur Backend v1.0.0 (BRAINEE-LIVING)
 * ================================================
...
discord.once('clientReady', async () => {
  ...
  pushLog('SYS', `🧠 BRAINEXE v1.0.0 — Bot : ${discord.user.tag}`);
  ...
  await syncDiscordToFile('Démarrage v1.0.0');
});
...
process.on('unhandledRejection', (reason) => {
  pushLog('ERR', `Unhandled rejection: ${reason?.message || reason}`, 'error');
});
